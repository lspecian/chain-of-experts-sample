# AWS Prod ECS Module Configuration
...
inputs = {
  ...
  create_placeholder_secrets = false  # Don't create placeholder secrets in prod
  ...
  cluster_cpu_threshold_percent = 70  # Lower threshold for prod to give more time to react
